...
[Flash.actionsPanel](./flash_object_(fl)/fl.md)

[Flash.addEventListener.()](./flash_object_(fl)/fl1.md)

[Flash.addToolInToolbar.()](./flash_object_(fl)/fl82.md)

[Flash.as3PackagePaths](./flash_object_(fl)/fl2.md)

[Flash.browseForFileURL.()](./flash_object_(fl)/fl3.md)

[Flash.browseForFolderURL.()](./flash_object_(fl)/fl4.md)

[Flash.clearPublishCache.()](./flash_object_(fl)/fl5.md)

[Flash.clipCopyString.()](./flash_object_(fl)/fl6.md)

[Flash.closeAll.()](./flash_object_(fl)/fl7.md)

[Flash.closeAllPlayerDocuments.()](./flash_object_(fl)/fl8.md)

[Flash.closeDocument.()](./flash_object_(fl)/fl9.md)

[Flash.compilerErrors](./flash_object_(fl)/fl10.md)

[Flash.componentsPanel](./flash_object_(fl)/fl11.md)

[Flash.configDirectory](./flash_object_(fl)/fl12.md)

[Flash.configURI](./flash_object_(fl)/fl13.md)

[Flash.contactSensitiveSelection](./flash_object_(fl)/fl14.md)

[Flash.copyLibraryItem.()](./flash_object_(fl)/fl15.md)

[Flash.createDocument.()](./flash_object_(fl)/fl16.md)

[Flash.createNewDocList](./flash_object_(fl)/fl17.md)

[Flash.createNewDocListType](./flash_object_(fl)/fl18.md)

[Flash.createNewTemplateList](./flash_object_(fl)/fl19.md)

[Flash.documents](./flash_object_(fl)/fl20.md)

[Flash.drawingLayer](./flash_object_(fl)/fl21.md)

[Flash.exportPublishProfileString.()](./flash_object_(fl)/fl22.md)

[Flash.externalLibraryPath](./flash_object_(fl)/fl23.md)

[Flash.fileExists.()](./flash_object_(fl)/fl24.md)

[Flash.findDocumentDOM.()](./flash_object_(fl)/fl25.md)

[Flash.findDocumentIndex.()](./flash_object_(fl)/fl26.md)

[Flash.findObjectInDocByName.()](./flash_object_(fl)/fl27.md)

[Flash.findObjectInDocByType.()](./flash_object_(fl)/fl28.md)

[Flash.flexSDKPath](./flash_object_(fl)/fl29.md)

[Flash.getAppMemoryInfo.()](./flash_object_(fl)/fl30.md)

[Flash.getDocumentDOM.()](./flash_object_(fl)/fl31.md)

[Flash.getThemeColor.()](./flash_object_(fl)/fl32.md)

[Flash.getThemeColorParameters.()](./flash_object_(fl)/fl33.md)

[Flash.getThemeFontInfo.()](./flash_object_(fl)/fl34.md)

[Flash.getSwfPanel.()](./flash_object_(fl)/fl35.md)

[Flash.installedPlayers](./flash_object_(fl)/fl36.md)

[Flash.isFontInstalled.()](./flash_object_(fl)/fl37.md)

[Flash.languageCode](./flash_object_(fl)/fl38.md)

[Flash.libraryPath](./flash_object_(fl)/fl39.md)

[Flash.mapPlayerURL.()](./flash_object_(fl)/fl40.md)

[Flash.Math](./flash_object_(fl)/fl41.md)

[Flash.mruRecentFileList](./flash_object_(fl)/fl42.md)

[Flash.mruRecentFileListType](./flash_object_(fl)/fl43.md)

[Flash.objectDrawingMode](./flash_object_(fl)/fl44.md)

[Flash.openDocument.()](./flash_object_(fl)/fl45.md)

[Flash.openScript.()](./flash_object_(fl)/fl46.md)

[Flash.outputPanel](./flash_object_(fl)/fl47.md)

[Flash.packagePaths-dropped](./flash_object_(fl)/fl48.md)

[Flash.presetPanel](./flash_object_(fl)/fl49.md)

[Flash.publishCacheDiskSizeMax](./flash_object_(fl)/fl50.md)

[Flash.publishCacheEnabled](./flash_object_(fl)/fl51.md)

[Flash.publishCacheMemoryEntrySizeLimit](./flash_object_(fl)/fl52.md)

[Flash.publishCacheMemorySizeMax](./flash_object_(fl)/fl53.md)

[Flash.publishDocument.()](./flash_object_(fl)/fl54.md)

[Flash.quit.()](./flash_object_(fl)/fl55.md)

[Flash.reloadEffects.md)-dropped](./flash_object_(fl)/fl56.md)

[Flash.reloadTools.()](./flash_object_(fl)/fl57.md)

[Flash.removeEventListener.()](./flash_object_(fl)/fl58.md)

[Flash.resetAS3PackagePaths.()](./flash_object_(fl)/fl59.md)

[Flash.resetPackagePaths.md)-dropped](./flash_object_(fl)/fl60.md)

[Flash.revertDocument.()](./flash_object_(fl)/fl61.md)

[Flash.runScript.()](./flash_object_(fl)/fl62.md)

[Flash.saveAll.()](./flash_object_(fl)/fl63.md)

[Flash.saveDocument.()](./flash_object_(fl)/fl64.md)

[Flash.saveDocumentAs.()](./flash_object_(fl)/fl65.md)

[Flash.scriptURI](./flash_object_(fl)/fl66.md)

[Flash.selectElement.()](./flash_object_(fl)/fl67.md)

[Flash.selectTool.()](./flash_object_(fl)/fl68.md)

[Flash.setActiveWindow.()](./flash_object_(fl)/fl69.md)

[Flash.showIdleMessage.()](./flash_object_(fl)/fl70.md)

[Flash.setPrefBoolean.()](./flash_object_(fl)/fl71.md)

[Flash.sourcePath](./flash_object_(fl)/fl72.md)

[Flash.spriteSheetExporter](./flash_object_(fl)/fl73.md)

[Flash.swfPanels](./flash_object_(fl)/fl74.md)

[Flash.toggleBreakpoint.()](./flash_object_(fl)/fl75.md)

[Flash.tools](./flash_object_(fl)/fl76.md)

[Flash.trace.()](./flash_object_(fl)/fl77.md)

[Flash.version](./flash_object_(fl)/fl78.md)

[Flash.xmlPanel.()](./flash_object_(fl)/fl79.md)

[Flash.xmlPanelFromString.()](./flash_object_(fl)/fl80.md)

[Flash.xmlui](./flash_object_(fl)/fl81.md)
